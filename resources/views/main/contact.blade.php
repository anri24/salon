...
<!-- Mirrored from demo.xpeedstudio.com/html/beautypress/contact-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Oct 2022 12:53:13 GMT -->
<head>
<meta charset="utf-8">
...
<h1 class="color-white">კონტაქტი</h1>
</div>
...
<li><i class="fa fa-map-marker"></i>ლუკა ასათიანის 45</li>
<li><i class="xsicon icon-phone3"></i>+995 593 50 50 41</li>
<li><i class="xsicon icon-envelope5"></i>anrivarshanidze24@gmail.com</li>
<li><i class="fa fa-facebook"></i><a href="https://www.facebook.com/natali.bolqvadze.12">ნატალია ბოლქვაძე</a></li>
</ul>
</div>
</div>
</div>
...
<footer style="background-color: #590D88; color:white;" class="beautypress-footer-section-v3">
	...
	<p style="font-size:20px;">ორშაბათი - შაბათი: <br>8:00 - 21:00 <span>Sunday: Closed</span></p>
	</div>
	</div>
	</div>
	</div>
