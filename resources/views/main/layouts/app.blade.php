    ...
    <header class="beautypress-header-section beautypress-version-1 beautypress-extra-css menu-skew bg-color-purple header-height-calc-minus navbar-fixed">
        <div class="container">
            <div class="beautypress-logo-wraper">
                <a href="{{ route('main.index') }}" class="beautypress-logo beautypress-version-2  beautypress-version-4">
            ...
            <div class="container">
                <nav class="xs_nav beautypress-nav beautypress-mega-menu">
                    ...
                    <div class="nav-menus-wrapper">
                        <ul class="nav-menu">
                            <li><a id="headertxt" href="{{ route('student.index') }}">მოსწავლეებისთვის</a>


                            <li><a id="headertxt" href="{{ route('about') }}">ჩვენს შესახებ</a>

                            </li>

                            <li><a id="headertxt" href="{{ route('portfolio') }}">პორთფოლიო</a>

                            </li>

                            <li><a id="headertxt" href="{{ route('contact') }}">კონტაქტი</a>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="beautypress-single-footer-details">
                            ...
                            <div class="beautypress-footer-details-text beautypress-green">
                                ...
                                <p style="font-size:20px;">ორშაბათი - კვირა: <br>9:00 - 00:00</p>
                            </div>
                        </div>
                    </div>
                </div>
