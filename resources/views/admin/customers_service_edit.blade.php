            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-4 col-xl-4">
                    <div class="beautypress-single-pricing-table">
                        <!-- forma iqneba aq -->
                        <center>
                            <form action="{{ route('update.customer.service',$customerService->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                <label for="service" class="form-label">აირჩიეთ სერვისის ჩარჩო</label>
                                <select class="form-select" name="customer_services_place"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $customerService->service }}" class="form-control"
                                           name="service" id="service">
                                </div>
                                <div class="mb-3">
                                    <label for="price" class="form-label">ფასი</label>
                                    <input type="text" value="{{ $customerService->price }}" class="form-control"
                                           name="price" id="price">
                                </div>
